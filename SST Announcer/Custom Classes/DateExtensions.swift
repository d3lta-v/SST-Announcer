...
extension Date {
    ...
    /// Decodes a date to ___ mins ago or ___ hrs ago. If all else fails, this method will decode the date to a yyyy/MM/dd format (ISO 8601)
    ...
    public func decodeToTimeAgo() -> String {
        ...
        if difference < 24*60*60 { // Between 1hr and 24 hours
            return "Today"
        } else if difference >= 24*60*60 && difference < 24*60*60*14 { // Between 1 day and 1 fortnight
