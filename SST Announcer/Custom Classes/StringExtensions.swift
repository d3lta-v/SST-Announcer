...
extension String {
  ...
  /// A computed variable for if the item has undisplayable traits for the iPhone
  var hasUndisplayableTraits: Bool {
    if self.range(of: "<iframe") != nil {
      return true
    }
    if self.range(of: "<table") != nil {
      return true
    }
    return false
  }

  /// A computed variable for if the item has undisplayable traits for the ⌚️
  var hasUndisplayableTraitsForWatch: Bool {
    if self.range(of: "<iframe") != nil {
      return true
    }
    if self.range(of: "<table") != nil {
  ...
  /**
   ...
   This method is designed specifically for DTCoreText
   */
