...
extension String {
    ...
    /**
     An `NSAttributedString` generated from a HTML `String`, intended for use as a simple
     decoding function on the Apple Watch

     *NOTE: Using this function is processor intensive, do NOT use it on multiple pieces 
     of content at once*
     */
    ...
    /**
     String representation of "clean" HTML, eliminating "dirty" HTML caused by text to HTML editors 
     like Blogger, as well as bad authors using websites like Blogger causing faulty text to be 
     generated by the editor in Blogger
     */
